...
public class BackTestDemo extends BaseTest{
	...
	@Test(priority=2,dataProvider="excel2",dataProviderClass=NSDataProvider.class)//系统-禁止ip访问
	...
	@Test(priority=6,dataProvider="excel3",dataProviderClass=NSDataProvider.class) //系统-修改页面缓存时间
	...
	@Test(priority=7,dataProvider="excel4",dataProviderClass=NSDataProvider.class) //系统-修改上传图片类型
	...
	@Test(priority=10,dataProvider="excel5",dataProviderClass=NSDataProvider.class) //系统-搜索导航
	...
	@Test(priority=12,dataProvider="excel6",dataProviderClass=NSDataProvider.class) //系统-更改网站标题
	...
	@Test(priority=13,dataProvider="excel7",dataProviderClass=NSDataProvider.class) //系统-更改积分
	...
	@Test(priority=16,dataProvider="excel8",dataProviderClass=NSDataProvider.class) //系统-修改链接地址
	...
	@Test(priority=17,dataProvider="excel9",dataProviderClass=NSDataProvider.class) //系统-添加类别
	...
	@Test(priority=21,dataProvider="excel10",dataProviderClass=NSDataProvider.class) //系统-添加会员类别
	...
	@Test(priority=23,dataProvider="excel11",dataProviderClass=NSDataProvider.class) //系统-添加举报原因
	...
	@Test(priority=25,dataProvider="excel12",dataProviderClass=NSDataProvider.class) //系统-添加管理员
	public void test37(String s1,String s2,String s3,String s4,String s5) throws InterruptedException {
		...
		webtest.click("xpath=//dd[text()='管理员']");
	...
	@Test(priority=26,dataProvider="excel13",dataProviderClass=NSDataProvider.class) //系统-添加类型
	...
	@Test(priority=33,dataProvider="excel14",dataProviderClass=NSDataProvider.class) //系统-添加百度
	...
	@Test(priority=34,dataProvider="excel15",dataProviderClass=NSDataProvider.class) //系统-添加类别
	...
	@Test(priority=36,dataProvider="excel16",dataProviderClass=NSDataProvider.class) //系统-添加分站
	...
	@Test(priority=38,dataProvider="excel18",dataProviderClass=NSDataProvider.class) //系统-发送系统消息
