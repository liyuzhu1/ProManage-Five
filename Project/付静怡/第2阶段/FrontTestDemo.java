...
public class FrontTestDemo extends BaseTest{
	//前台测试用例不需要登录
		...
		@Test(dataProvider="excel18",dataProviderClass=NSDataProvider.class) //找工作-清除关键词
		...
		@Test(dataProvider="excel19",dataProviderClass=NSDataProvider.class) //店铺招聘-发布招聘信息
