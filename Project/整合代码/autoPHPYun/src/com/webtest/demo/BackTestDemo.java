...
//	登录后台,进入内容页面
	...
	public void test25(String s1, String s2, String s3, String s4, String s5, String s6, String s7, String s8)
	...
	public void test26(String s1, String s2, String s3, String s4, String s5) throws InterruptedException {
		Thread.sleep(5000);
	...
	public void test28(String s1) throws InterruptedException {
		...
		webtest.click("xpath=//td[@lay-ymd='2020-12-1']");
		webtest.click("xpath=//td[@lay-ymd='2021-2-4']");
