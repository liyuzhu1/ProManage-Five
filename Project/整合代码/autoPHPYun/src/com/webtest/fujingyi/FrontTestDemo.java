...
public class FrontTestDemo extends BaseTest{
	...
	public void test01() throws InterruptedException {
		...
		Thread.sleep(3000);
		webtest.click("xpath=//ul[@class='search_Filter_list']/li[1]/a[1]/span[1]");
		Thread.sleep(3000);
	}
	
	@Test(priority=1,dataProvider="excel17",dataProviderClass=NSDataProviderFujingyi.class)  //职场问答- 搜索
	...
	@Test(priority=7,dataProvider="excel18",dataProviderClass=NSDataProviderFujingyi.class) //找工作-搜索职位或公司
	...
	@Test(dataProvider="excel18",dataProviderClass=NSDataProviderFujingyi.class) //找工作-清除关键词
	...
	@Test(dataProvider="excel19",dataProviderClass=NSDataProviderFujingyi.class) //店铺招聘-发布招聘信息
	public void test02(String s1,String s2,String s3,String s4,String s5,String s6,String s7,String s8,String s9,String s10) throws InterruptedException {
		webtest.click("xpath=//a[text()='网站导航']");
	...
	@Test(priority=12,dataProvider="excel20",dataProviderClass=NSDataProviderFujingyi.class) //店铺信息-筛选店铺信息
