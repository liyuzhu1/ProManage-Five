...
public class FrontTestDemo extends BaseTest {
	...
	public void testA1() throws InterruptedException {
		...
		Thread.sleep(3000);
		webtest.type("id=username1", "phpyun");// 用户名
		webtest.type("id=CheckCode", "1111");// 验证码
		webtest.type("id=password", "123456");// 密码
		webtest.type("id=passconfirm", "123456");// 确认密码
		Thread.sleep(3000);
		...
		Thread.sleep(3000);
		// 薪资
		webtest.type("id=minsalary", "3000");
		webtest.type("id=maxsalary", "5000");
		...
		// 学校
		webtest.type("id=eduname", "河北师范大学");
	...
	public void testA2() throws InterruptedException {
		...
		Thread.sleep(3000);
		webtest.type("id=username", "phpyun");
		Thread.sleep(3000);
	...
	// 搜索框的下拉列表功能
	@Test
	public void testA5() throws InterruptedException {
		...
		Thread.sleep(3000);
		webtest.type("xpath=//input[@placeholder='请输入要搜索的关键字，如 会计,仓管,设计师等']", "测试");
	...
	// 个人中心-测试刷新简历功能
	@Test
	public void testA8() throws InterruptedException {
...
//		Thread.sleep(3000);
	...
	// 个人中心-退出登录功能
	@Test
	public void testA9() throws InterruptedException {
	...
	public void testB0() throws InterruptedException {
		...
		webtest.typeAndClear("id=name", "phpyun01");
	...
	public void testB2() throws InterruptedException {
		...
		// 薪资待遇
		webtest.type("id=minsalary", "3000");
		webtest.type("id=maxsalary", "8000");
		// 工作性质
	...
	public void testB3() throws InterruptedException {
		...
		webtest.type("id=email", "lyz3249174527@163.com");
		webtest.type("id=comname", "京东");
		webtest.type("id=jobname", "测试");
		webtest.click("name=submit");
		Thread.sleep(3000);
	...
	// 购买足够积分的简历
	@Test
	public void testB4() throws InterruptedException {
	...
	// 有两个简历
	@Test
	public void testB5() throws InterruptedException {
	...
	// 职位管理器数量小于2
	@Test
	public void testB6() throws InterruptedException {
		...
		Thread.sleep(3000);
		// "职位搜索器"
		webtest.type("xpath=//input[@placeholder=' 如，搜索会计']", "测试");
		webtest.type("name=keyword", "测试");
		webtest.click("xpath=//input[@placeholder='请选择行业']");
		webtest.click("xpath=//dd[text()='计算机/互联网']");
		webtest.click("xpath=//input[@placeholder='请选择工作地区']");
		webtest.click("xpath=//dd[text()='北京']");
		webtest.type("id=minsalary", "3333");
		webtest.type("id=maxsalary", "9999");
	...
	// 之前无未支付的订单
	@Test
	public void testB7() throws InterruptedException {
	...
	// 财务管理-取消充值功能
	@Test
	public void testB8() throws InterruptedException {
	...
	// 之前未签到
	@Test
	public void testB9() throws InterruptedException {
	...
	public void testC1() throws InterruptedException {
		...
		webtest.type("id=username", "phpyun01");
		webtest.type("id=password", "123456");
	...
	public void testC2() throws InterruptedException {
		...
		webtest.type("id=oldpassword", "123456");
		webtest.type("id=newpassword", "1234567");
		webtest.type("id=repassword", "1234567");
		webtest.click("name=submit");
		Thread.sleep(5000);
		// 重新登录
		webtest.type("id=username", "phpyun01");
		Thread.sleep(3000);
		webtest.click("id=password2");
		webtest.type("id=password", "1234567");
		webtest.click("id=sublogin");
		Thread.sleep(3000);
